    ...
    return (
        <div className="lg:mx-20 p-2 my-12">
            <div className="flex justify-between">
                ...
                <Link to='/vehicles' className="flex max-[430px]:flex-col max-[430px]:justify-center items-center gap-2 font-bold text-2xl border-black lg:border-none border-2 max-[430px]:w-[200px]">View All <FaLongArrowAltRight />  </Link>
            </div>
            ...
            <div className="card-container w-[100%] flex max-[430px]:flex-col flex-wrap gap-9 justify-center">
             {cars.slice(0, 6).map((element,index)=>
                ...
                <div key={index} className="card lg:w-[30%] bg-[#fafafa] flex flex-col justify-center gap-9 rounded-lg p-3">
                    ...
                    <button onClick={() => { navigate(`/details/${element.id}`) }} className="w-[90%] bg-[#5937e0] rounded-lg self-center p-2 text-white"><b>View details</b></button>
                </div>
